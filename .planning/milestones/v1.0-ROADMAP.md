...
- [x] **Phase 3: UI** - Compose screens for device list, balance sliders, toggles, and permission flows (gap closure in progress) (completed 2026-04-06)
...
- [ ] 03-04-PLAN.md — Gap closure: autoApply guard in AudioBalanceService (UI-03)
